    ...
    public partial class AddedEntities : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_QuestPhotos", x => x.Id);
                    table.ForeignKey(
                        name: "FK_QuestPhotos_Quests_QuestId",
                        column: x => x.QuestId,
                        principalTable: "Quests",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Reviews_Quests_QuestId",
                        column: x => x.QuestId,
                        principalTable: "Quests",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QuestPhotos_QuestId",
                table: "QuestPhotos",
                column: "QuestId");

            migrationBuilder.CreateIndex(
                name: "IX_Reviews_QuestId",
                table: "Reviews",
                column: "QuestId");
